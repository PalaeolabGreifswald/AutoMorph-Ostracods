...
input_folder = "C:/Users/MH/Desktop/Kern_Test/Kern_Test/final/f_LV_dors/morph2d/coordinates"
output_filename = "f_LV_dors_coord.tps"
...
for filename in os.listdir(input_folder):
    if filename.endswith("_original.csv"):
        ...
        if "SampleID" in df.columns and "ObjectID" in df.columns and "x" in df.columns and "y" in df.columns:
            ...
            # Neue Reihenfolge: linker Punkt, rechter Punkt, dann alle Originalpunkte
